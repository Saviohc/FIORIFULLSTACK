		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ListadePlantas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ListadePlantas-display": {
								"semanticObject": "ListadePlantas",
								"action": "display",
								"description": "Exibe a lista de plantas",
								"title": "Lista de Plantas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ovly.T55.fiori50.plantas",
									"url": sap.ui.require.toUrl("ovly/T55/fiori50/plantas")
								}
							}
						}
					}
